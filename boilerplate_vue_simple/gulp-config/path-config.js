module.exports = {
    build: {
        html: './' /* path to ready htmls */,
        js: 'build/js/' /* path to ready js */,
        css: 'build/css/' /* path to ready css */,
        img: 'build/images/' /* path to ready images */,
        media: 'build/media/' /* path to ready media-files */,
        svg: 'build/svg/' /* path to ready svg */,
        fonts: 'build/fonts/' /* path to ready fonts */,
    },
    src: {
    ...
    watch: {
        ...
        js: 'src/js/**/*.+(js|vue)' /* path for watch js files */,
    ...
    clean: 'build/' /* path for clean files */,
    port: '6061',
};
